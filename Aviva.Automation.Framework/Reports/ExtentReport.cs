    ...
    public class ExtentReport
    {
        ...
        public void InitializeReport()
        {
            try
            {
                ...
                Assembly assembly = typeof(Aviva.Automation.Framework.ExtentReport).Assembly;

                using (Stream configFileStream = assembly.GetManifestResourceStream("Aviva.Automation.Framework.Reports.Config.ExtentReportConfig.xml"))
                {
